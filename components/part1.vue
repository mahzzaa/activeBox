  ...
  >
    <div class="flex flex-row xs:flex-wrap">
      ...
      >
        ...
        <p class="xs:hidden font-thin text-gray-600 text-sm text-center">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia repellat
          esse iure corrupti numquam sequi odio necessitatibus incidunt atque
          impedit dolorum itaque assumenda
        </p>
      </div>
      <div
        class="flex flex-col items-center justify-center w-1/3 mb-0 m-6 p-6 "
